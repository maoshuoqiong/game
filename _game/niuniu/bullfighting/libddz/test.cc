...
{	
    ...
    */
	...
	deck.get_hole_cards_bomb(hole_cards1);
	deck.get_hole_cards_bomb(hole_cards2);
	deck.get_hole_cards_bomb(hole_cards3);
	// deck.get_community_cards(community_cards);
	
	Card card0(0x1d);
	community_cards.add_card(card0);
	Card card1(0x02);
	community_cards.add_card(card1);
	Card card2(0x01);
	community_cards.add_card(card2);
	...
	else if (mode == 3)
	{
		...
		int arr0[] = {0x0d, 0x01, 0x0a, 0x02, 0x0C, 0x0E,  0x19, 0x29, 0x39,  0x0B, 0x1B, 0x2B, 0x3B, 0x03, 0x13, 0x23, 0x34, 0x35, 0x06, 0x26, 0x36, 0x07};
