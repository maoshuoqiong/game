...
// 		$now = strtotime("2014-10-01 10:01:00");	
		...
		$pUinfo = $this->data_redis->hMget ( "hu:{$this->uid}", array ("login_days"));
		$vlevel = CommonTool::isVip($this->data_redis, $this->uid);
...
// 			var_dump($pSignin);
		...
		$pInfo = $this->data_redis->hMget("hu:{$this->uid}",array('coin','money'));
//  		var_dump($tot_item);
// 		var_dump($cont_item);
// 		var_dump($vip_item);
		$retInfo = array(
